...
笔记<span style="color: red">力求简洁,实现阅读流畅,易于理解和记忆,方便使用</span>的目标.



强烈的感受:

找到适合自己的好资料(这么说有点矛盾,好资料必然是适合绝大数的人)是在太重要了.

这次的偶遇纯粹是处于偶然.这也说明,在学习新知识之前,进行资料的收集是多么重要.

我们可以重新整理下这个流程:

1.确定学习的知识

2.收集资料(渠道是通过搜索引擎来寻找入门教程, 搜索引擎一般是goo, 来源一般是知乎,博客)

3.资料收集以后,以下是重点.

3.1 我们要快速翻阅,不要留恋于具体知识点的理解. 要从知识点的接受度上来判断首先精读哪些资料.

3.2 至于理解和记忆困难的资料,如果精读资料是覆盖其内容的话,不读也罢. 最近发现mdn的正则表达式篇章在使用上十分的不友好. 

3.3 文档并不一定是最好的阅读资料,因为它只讲了是什么和为什么,大概率没有怎么用.



**js正则表达式mini书**,读起来非常流畅且易于记忆,比起mdn效率高了不止一个量级.



当然这也是有感而发,并不一定是right,但是大体思路应该是没有什么问题的
