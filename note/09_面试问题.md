...
例如:一个盒子模型是margin:20px; padding:10px; border:10px; width:200px; height:50px;

w3c盒模型:
宽度:margin*2+border*2+padding*2+width = 280px
高度:margin*2+border*2+padding*2+height = 130px
实际宽度: border*2+padding*2+width = 240px
实际高度: border*2+padding*2+height = 90px

IE盒子模型:
宽度: margin*2+width = 240px;
高度: margin*2+height = 90px
实际宽度: 200px;
实际高度: 50px;

//chorme是标准规范。即width和height不包含padding和border. 
//解决方法:
